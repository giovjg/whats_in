...
client_photo = URI.open('https://media-exp1.licdn.com/dms/image/C4D03AQELp7bJRzb9Aw/profile-displayphoto-shrink_200_200/0/1611674841725?e=1651104000&v=beta&t=rhXKn8wnhj7mDq1uBHHq0q-8uGMDM2DVxCarb3IaCYg')
user_client.photo.attach(io: client_photo, filename: "user_client.jpg", content_type: 'image/jpeg')
...
user_owner.photo.attach(io: owner_photo, filename: "owner.jpg", content_type: 'image/jpeg')

user_lidia = User.create!(email: "lidia@lidia.com", password: "lidia1")
